...
export default function EisenhowerMatrix({ todos, todoService, onSelectTodoId, userId, projects, onAutoCategorize }: EisenhowerMatrixProps) {
  ...
  return (
    <div className="w-full flex flex-col h-full">
      <div className="mb-6">
        <h2 className="text-xl font-black text-gray-900">Eisenhower Priority Matrix</h2>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-1">
                <h3 className={`font-bold text-sm tracking-tight ${q.textColor} flex items-center`}>
