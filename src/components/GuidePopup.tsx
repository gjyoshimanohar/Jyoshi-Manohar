  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden flex flex-col border border-gray-100 animate-in fade-in zoom-in-95 duration-200">
        ...
        {/* Header banner */}
        <div className="bg-[#2F6BE6] p-6 text-white text-left relative">
          <button 
            onClick={onClose} 
          ...
          <span className="text-[10px] font-bold bg-white/20 text-white uppercase px-2 py-0.5 rounded-full tracking-widest">
            TickTick Desktop Guide
          </span>
          <h3 className="text-xl font-black mt-2">Welcome to your workspace</h3>
        ...
        <div className="p-6 overflow-y-auto max-h-[400px] space-y-4 text-left">
          <div className="flex items-start space-x-3">
            <div className="bg-[#2F6BE6]/10 p-2 rounded-xl text-[#2F6BE6] shrink-0">
              <CheckCircle className="w-4 h-4" />
            </div>
            <div>
              <h4 className="font-bold text-sm text-gray-900 leading-normal">Task Columns</h4>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-bold text-sm text-gray-900 leading-normal">Eisenhower Quadrants</h4>
              <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-bold text-sm text-gray-900 leading-normal">Habit Trackers</h4>
              <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-bold text-sm text-gray-900 leading-normal">Ambient Sound Synthesizers</h4>
              <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
        ...
        <div className="bg-gray-50 px-6 py-4 flex justify-end border-t border-gray-100">
          <button
            onClick={onClose}
            className="bg-[#2F6BE6] hover:bg-[#1a56cc] text-white px-5 py-2 rounded-lg text-xs font-bold transition-all shadow-md active:scale-98"
          >
            Acknowledge & Start
          </button>
        </div>
