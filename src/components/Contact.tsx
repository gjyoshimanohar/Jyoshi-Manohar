        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mt-8">
          <div className="flex flex-col justify-between relative">
            <div className="relative z-10">
              <p className="inline-flex items-center space-x-2 bg-primary/5 border border-primary/10 text-primary font-bold tracking-widest uppercase text-xs px-4 py-2 rounded-full mb-8 shadow-sm w-max">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={idx} className="flex items-center space-x-6">
                    ...
                    <div>
                      <div className="text-xs font-bold text-black/50 uppercase tracking-widest leading-none mb-2">
                        {item.label}
                      </div>
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl text-base font-bold text-primary focus:bg-white focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all"
              ...
              <div className="space-y-2">
                ...
                <div className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl text-base font-bold text-primary focus:bg-white focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all flex items-center justify-between group"
                  >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  rows={3}
                  className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl text-base font-bold text-primary focus:bg-white focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all resize-none"
                  placeholder="Describe your context"
                ></textarea>
              </div>
              <button
                type="button"
                className="w-full bg-primary text-white py-5 text-sm font-bold tracking-widest uppercase hover:bg-secondary transition-all flex items-center justify-center space-x-3 group rounded-full shadow-md hover:shadow-lg hover:-translate-y-1"
              >
