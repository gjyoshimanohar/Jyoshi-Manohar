...
export default function Admin() {
 ...
 <button onClick={() => { handleSeedData(); setConfirmSeed(false); }} className="px-3 py-2 bg-secondary text-white font-medium text-xs">Yes</button>
 <button onClick={() => setConfirmSeed(false)} className="px-3 py-2 bg-slate-200 text-black font-medium text-xs">No</button>
 </div>
 )}
 <button
 ...
 <span className="text-xs font-medium uppercase tracking-widest hidden sm:inline">Logout</span>
 ...
 <h2 className="text-2xl text-primary">{editingPost.id ? 'Edit Post' : 'Create New Post'}</h2>
 <button 
 ...
 <div>
 <label className="block text-xs uppercase tracking-widest text-black mb-3">Post Title</label>
 <input
 required
 type="text"
 ...
 <div>
 <label className="block text-xs uppercase tracking-widest text-black mb-3">URL Slug</label>
 <input
 required
 type="text"
 ...
 <span className="text-xs text-secondary uppercase tracking-widest">{post.category}</span>
 ...
 <span className="text-xs font-medium text-red-500 mr-2">Confirm?</span>
 <button onClick={() => handleDelete(post.id)} className="px-3 py-1 bg-red-500 text-white font-medium text-xs">Yes</button>
 <button onClick={() => setConfirmDeleteId(null)} className="px-3 py-1 bg-slate-200 text-black font-medium text-xs">No</button>
 </div>
 ) : (
 <button
