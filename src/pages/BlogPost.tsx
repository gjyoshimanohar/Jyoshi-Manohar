    ...
    <main className="pt-32 pb-24 bg-white">
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 border-x border-border">
        ...
        >
          <Link 
            to="/blog" 
            className="inline-flex items-center text-xs font-black uppercase tracking-[0.2em] text-black hover:text-primary transition-colors mb-12 group"
          >
          ...
          <div className="flex flex-wrap items-center justify-between gap-10 py-10 border-y border-border mb-16">
            <div className="flex items-center space-x-10">
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-black/50 uppercase tracking-widest mb-1">Published</span>
                <span className="text-xs font-bold text-black uppercase tracking-widest">{post.date}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-black/50 uppercase tracking-widest mb-1">Read Time</span>
                <span className="text-xs font-bold text-black uppercase tracking-widest">{post.readTime}</span>
              </div>
            </div>
        ...
        <motion.div
          ...
          className="prose prose-lg lg:prose-xl prose-slate max-w-none prose-headings:font-black prose-headings:capitalize prose-headings:tracking-tighter prose-a:text-secondary mb-24"
        >
          <div 
        ...
        <div className="py-20 border-t border-border">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="flex items-center space-x-8">
              <div>
                <h4 className="text-lg font-black text-primary mb-1">Jyoshi Manohar</h4>
                <p className="text-xs font-bold text-black capitalize tracking-widest leading-relaxed text-justify">
