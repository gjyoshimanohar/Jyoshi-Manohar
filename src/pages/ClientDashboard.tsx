...
export default function ClientDashboard() {
  ...
  const [opsModalType, setOpsModalType] = useState<
    "app" | "doc" | "filing" | null
  >(null);
              ...
              <div className="space-y-3 transition-all duration-300 w-full">
                ...
                {(!isAdmin || selectedClientId) && (
                  <>
                    ...
                    <button
                      onClick={() => setActiveTab("book-consultation")}
                      className={`w-full flex items-center ${isSidebarOpen ? "justify-start p-4" : "justify-center p-3"} rounded-xl text-left transition-all border ${
                  ...
                  <div className="bg-white p-4 sm:p-4 sm:p-5 rounded-2xl border border-slate-100/60 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4 relative overflow-hidden">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1 max-w-2xl leading-relaxed">
                          Control center overview of registered client
                          workspaces, statutory filings, documents vault, and
                        ...
                        <div className="flex justify-between items-center border-b border-slate-100/60 pb-3 mb-5">
                          <div>
                            <h3 className="text-base font-semibold text-primary tracking-tight flex items-center gap-1.5">
                              ...
                              <span>
                                Direct Workspace Focus Launcher (
                                {clients.length})
                              </span>
                            </h3>
                            <p className="text-[10px] text-slate-400 mt-0.5">
                              Quickly select customer profile to track
                              documents, filings, and chats
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-100/60 shadow-sm flex flex-col sm:flex-row justify-between gap-4">
                        <div>
                          ...
                          <p className="text-xs text-slate-500 mt-1">
                            Official MCA filings, Income tax acknowledgements,
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:p-5">
                        {regularDocs.length === 0 ? (
                          <div className="col-span-full bg-white rounded-3xl p-5 sm:p-4 sm:p-5 sm:p-12 text-center border border-slate-100/60 shadow-sm">
                            ...
                            <p className="text-xs text-slate-500 mt-1">
                              Certified audit copies will appear here once
                              drafted by CA Manohar.
                            </p>
                          </div>
                        ) : (
                          regularDocs
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100/60 pb-6 mb-6">
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1 max-w-xl">
                          Schedule a one-on-one video call or meeting with our compliance experts via Calendly.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-3xl border border-slate-100/60 p-4 sm:p-5 md:p-5 sm:p-4 sm:p-5 shadow-sm">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100/60 pb-6 mb-6">
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1 max-w-xl">
                          Real-time chat line for regulatory inquiries,
                          structural advice, and direct document uploads.
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      {isAdmin && (
                        ...
                        >
                          ...
                          <p className="text-[10px] text-slate-400 leading-normal">
                            To create a new client thread, use the *Create
                            client stub* tool in the top Admin Control Room.
                          </p>
                        </div>
                      )}
                            ...
                            <div className="bg-amber-50/70 border border-amber-200/50 rounded-2xl p-4 space-y-3 mb-2 text-left shadow-sm">
                              <div className="flex justify-between items-center pb-2 border-b border-amber-200/30">
                                <h5 className="text-[10px] font-bold text-amber-800 uppercase tracking-widest flex items-center gap-1.5 font-mono">
                                  ...
                                  <span>
                                    Dispatch Official Document Request
                                  </span>
                                </h5>
                                <button
                                  type="button"
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-slate-950 text-white p-4 sm:p-4 sm:p-5 rounded-3xl border border-slate-800 shadow-lg">
                    ...
                    <p className="text-xs text-slate-400 mt-1 max-w-2xl leading-relaxed">
                      ...
                      blocks, certified PDF vouchers, or GSTR compliance dates
                      to the selected client's command interface in real-time.
                    </p>
                  </div>
                  ...
                  <div className="bg-slate-50 border border-slate-200/60 rounded-3xl p-4 sm:p-4 sm:p-5 shadow-sm">
                    ...
                    {clientRequests.length === 0 ? (
                      <div className="bg-white border border-slate-100/60 rounded-2xl py-8 px-6 text-center shadow-sm">
                        ...
                        <p className="text-[10px] text-slate-400 mt-0.5">
                          The consulting client intake cue is currently empty.
                          All clear for now!
                        </p>
                      </div>
                    ) : (
                                ...
                                >
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                      ...
                                      <div>
                                        <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-500 mb-1.5">
                                          Track Milestones Checklist (One step
                                          per line)
                                        </label>
                                        <textarea
                                          rows={3}
                                ...
                                >
                                  ...
                                  <div className="space-y-4">
                                    <div>
                                      ...
                                      <span className="text-[9px] text-slate-400 mt-1 block">
                                        {" "}
                                        This reason will automatically notify
                                        the client's consultation log and
                                        dashboard feed.
                                      </span>
                                    </div>
                                  </div>
                ...
                <div className="space-y-8">
                  <div className="bg-slate-950 text-white p-4 sm:p-4 sm:p-5 rounded-3xl border border-slate-800 shadow-lg">
                    ...
                    <p className="text-xs text-slate-400 mt-1 max-w-2xl leading-relaxed">
                      ...
                      blocks related to various government portals of the
                      selected client.
                    </p>
                  </div>
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <button
                                    onClick={async () => {
                                      if (
                                        confirm("Delete this account info?")
                                      ) {
                                        await deleteDoc(
                  ...
                  <div className="bg-white p-4 sm:p-4 sm:p-5 rounded-2xl border border-slate-100/60 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1 max-w-2xl leading-relaxed">
                          Create client stubs, view client account records,
                          delete client profiles, and select the specific client
                          thread context you want to manage across the workspace
                          portals.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-base font-semibold tracking-tight">
                        ...
                        {opsModalType === "doc" &&
                          "Deliver Legal Certified Document"}
                        {opsModalType === "filing" &&
                          "Push Scheduled Compliance Calendar Date"}
                      </h3>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                          ...
                          <CustomSelect
                            ...
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 text-xs font-semibold text-primary"
                            options={["Upcoming", "Overdue", "Filed"]}
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] text-slate-500 font-bold uppercase tracking-wider mb-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      ...
                      >
                        ...
                        <span className="text-[10px] text-slate-500 mt-1 font-normal leading-relaxed text-wrap">
                          Book a new corporate consulting service or client
                          audit.
                        </span>
                      </button>
                      ...
                      >
                        ...
                        <span className="text-[10px] text-slate-500 mt-1 font-normal leading-relaxed text-wrap">
                          Submit certificates, ledgers, or business KYC
                          paperwork.
                        </span>
                      </button>
                    </div>
