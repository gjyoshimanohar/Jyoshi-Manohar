...
const regex = /          \{\/\* Active \/ Real-Time Task Timers Section \*\/\}[\s\S]*?<h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider">Historical Logs<\/h3>\n            <div className="flex gap-2 bg-slate-50 p-1\.5 rounded-xl border border-slate-200">/g;
