...
c = c.replace(
  ...
  'className={`group relative overflow-hidden p-8 lg:p-10 rounded-3xl ${bgClass} shadow-[0_4px_20px_rgba(0,0,0,0.05)] border-slate-200/60 transition-all duration-500 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:-translate-y-2 hover:scale-[1.02] flex flex-col`}'
);
